...
export const global: globalType = {
    ...
    researchesExtraInfo: [
        {} as globalType['researchesExtraInfo'][0], { //Stage 1
            ...
            effectText: [
                () => `Increase strength of Cosmic dust by another ${format(1.01)} per level. Max level is based on effective Rank.\n(Total increase: ${format(1.01 ** player.researchesExtra[3][0], { padding: true })})`,
                () => { //[1]
